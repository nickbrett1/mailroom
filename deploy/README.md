# Deployment runbook: mailroom
# Generated by genproj (docker-container capability, registry=ghcr.io,
# network mode=bridge, watchtower=true, homepage=true)
...
`ghcr.io/nickbrett1/mailroom` on every push to
...
2. In `docker-compose.yml`, change the image to the pinned SHA:
   `image: ghcr.io/nickbrett1/mailroom:<commit-sha>`
